...
from .warp import fabric as fabric_utils
...
class XformPrimView:
    ...
    def __init__(
        ...
        stage = sim_compat.get_current_stage() if stage is None else stage
        ...
        if validate_xform_ops:
            for prim in self._prims:
                if not sim_compat.validate_standard_xform_ops(prim):
                    raise ValueError(
